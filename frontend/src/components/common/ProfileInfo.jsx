        ...
        <div className='text-center px-5 py-4'>
            <div className='flex flex-col'>
                <div className='flex justify-center items-center flex-col'>
                    ...
                    <h3 className='text-lg sm:text-2xl mt-2'>{user.name}</h3>
                ...
                <div className='w-full mt-5'>
                    <Link to='/themes' className='btn btn-md text-lg bg-transparent hover:border-primary w-full mt-2'>
                        <SunIcon size={24} />
                    ...
                    <button className='btn btn-md text-lg bg-transparent border hover:border-primary w-full mt-2' onClick={logout}>
                        <LogOut size={24} />
